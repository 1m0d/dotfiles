...
nnoremap <leader>f :Ack --ignore-dir=log ""<Left>
imap <D-CR> <Plug>(coc-snippets-expand-jump)
...
"
"
" Buffer will be hidden if trying to open new file whilst changes aren't saved
set hidden
...
" disabled so autopairs don't get overriden
